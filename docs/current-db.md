...
-- 2. TẠO SCHEMAS
IF NOT EXISTS (SELECT _ FROM sys.schemas WHERE name = 'Notification') EXEC('CREATE SCHEMA [Notification]')
IF NOT EXISTS (SELECT _ FROM sys.schemas WHERE name = 'System') EXEC('CREATE SCHEMA [System]')
GO
